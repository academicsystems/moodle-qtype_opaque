...
$string['couldnotpostquestionfile'] = 'Could not post the question file to the quiz engine. (Technical information: {$a})';
...
$string['invalidresponse'] = 'The response from the question engine is not in the correct format. ${a}';
...
$string['questionposterror'] = 'Your quiz engine did not accept posting the question file. <br>{$a}';
