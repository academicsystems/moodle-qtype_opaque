...
$string['couldnotpostquestionfile'] = 'Was not able to post the question file to the quiz engine. (Technical information: {$a})';
...
$string['invalidresponse'] = 'The response from the question engine is not in the correct format.';
...
$string['missingquestionfileinimport'] = 'Missing question file in import file.';
...
$string['questionbankurls'] = 'Question bank base URLs';
...
$string['questionfile'] = 'Question file';
...
$string['questionpostnotsupported'] = 'Your quiz engine did not accept posting the question file. <br>{$a}';
...
$string['webservice_help'] = 'Choose whether your question engine will interact with SOAP + XML or REST + JSON.';
